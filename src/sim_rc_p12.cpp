...
int main(int ac, char* av[]) 
{
	...
	P12Connection * con_ee;
	con_ee = new P12Connection(neurons_e,neurons_e,
			wee,sparseness,
			eta,
			kappa,
			wmax
	...
	// P12Connection * con_ei2 = new P12Connection(neurons_e,neurons_i2,
	// 		wei,sparseness,
	// 		eta,
	// 		alpha,
	// 		wmax
	...
	// External input
	P12Connection * con_stim_e = NULL;
	con_stim_e = new P12Connection( stimgroup, neurons_e,
		wext,sparseness_ext,
		eta,
		kappa, // supposedly deprecated
		wmax,
	...
	// External input
	// P12Connection * con_stim_i = NULL;
	// con_stim_i = new P12Connection( stimgroup, neurons_i2,
	// 	wext,sparseness_ext,
	// 	eta,
	// 	kappa, // supposedly deprecated
	// 	wmax,
	...
	StateMonitor * stmon_hom = new StateMonitor( neurons_e, 5, "P12hom_vector", string(strbuf), 1 ); 

	sprintf(strbuf, "%s/%s.%d.hom2", dir.c_str(), file_prefix.c_str(), sys->mpi_rank() );
	StateMonitor * stmon_hom2 = new StateMonitor( neurons_e, 6, "P12hom_vector", string(strbuf), 1 ); 
